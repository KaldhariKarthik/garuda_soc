...
//  RTL SOURCE : rtl/dsu/dsu_stall.v   (GARUDA_DSU_DesignSpec)
...
class stall_generator;
    ...
    function new(int num_random_seqs = 60, int random_seq_len = 40);
...
class stall_env;
    ...
    function new(virtual dsu_stall_if vif, int num_random_seqs = 60, int random_seq_len = 40);
        this.vif = vif;
    ...
    task run();
        ...
        tb_signoff(mon.cg_stall.get_coverage(), sb.fail_cnt);
